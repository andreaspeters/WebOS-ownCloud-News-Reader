...
*/
		...
		{kind: "Popup", name: "showSaveDialog", style: "width 500px; height 500px", components: [
			{name: "savearticle", className: "enyo-bg", kind: "MyApps.ExtSaveArticle", onReceive: "", onSave: "", onCancel: "closeSaveArticle"}
		]},

		// Print Dialog Box
		{name: "printDialog", kind: "PrintDialog", duplexOption: true, colorOption: true, frameToPrint: {name:"currentFeedItemWebView", landscape:false}, appName: "OwnCloud RSS News Reader"}
